<picture>
  ...
  <img src="./assets/hero.svg" width="100%" alt="Srishanth Goud — Curiosity in. Working software out. AI tools, web products, and Android experiments.">
</picture>
...
<p align="center">
  <a href="https://github.com/iamsrishanth/OpenTeleCRM"><img src="./assets/project-crm.svg" width="400" alt="OpenTeleCRM: a self-hosted sales CRM with NestJS, Next.js, and PostgreSQL. Explore the repository."></a>
  <a href="https://github.com/iamsrishanth/meta-ads-mcp"><img src="./assets/project-mcp.svg" width="400" alt="Meta Ads MCP: connect AI agents to advertising insights with Python and MCP. Explore the repository."></a>
  <br>
  <a href="https://github.com/iamsrishanth/DriveTV"><img src="./assets/project-drivetv.svg" width="400" alt="DriveTV: a native Kotlin Android TV client for streaming Google Drive videos. Explore the repository."></a>
  <a href="https://github.com/iamsrishanth/LaSabrosov3"><img src="./assets/project-web.svg" width="400" alt="La Sabroso: a cafe website built with Next.js, TypeScript, and Tailwind CSS. Explore the repository."></a>
</p>
...
<a href="https://github.com/iamsrishanth?tab=repositories">
  <picture>
    ...
    <img src="./assets/github-pulse.svg" width="100%" alt="GitHub activity snapshot: original public repository counts, primary languages, and repositories pushed in the last 30 days. Full figures and scope appear in the activity details below.">
  </picture>
</a>
...
<img src="./assets/footer.svg" width="100%" alt="End of file. Start a conversation.">
